...
@Component({
  ...
  styleUrls: ['./imei-modal.component.css']
})
export class ImeiModalComponent {
  private _open:boolean = true; 
    private _typeDialog:number = 0;
    private _headTitle:string = 'Verificación de IMEI'; 
    private _info:string = 'Estado del IMEI: XXXXXXXXXXXXXXX';
